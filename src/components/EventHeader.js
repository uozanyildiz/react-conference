  ...
  return (
    <div className='m-16'>
      <div className='flex flex-col pt-10 pb-24 p-10 bg-conference bg-fixed bg-center bg-cover bg-no-repeat'>
        <div className='bg-gradient-to-t from-blue-700 to-blue-900 opacity-90 text-blue-100 mb-auto bg-opacity-80 p-10 rounded-3xl shadow-xl '>
        ...
        <a
          href='/'
          className='mx-auto mt-10 p-2 bg-white bg-opacity-80 rounded-lg text-2xl text-blue-900 hover:text-blue-500'
        >
          Buy a ticket!
        </a>
      </div>
