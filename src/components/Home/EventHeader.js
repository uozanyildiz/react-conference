    ...
    <div className='m-8 mt-16'>
      <div className='flex flex-col pt-10 pb-24 p-10 bg-conference bg-fixed bg-center bg-cover bg-no-repeat'>
        <div className='bg-gradient-to-t from-indigo-700 to-indigo-900 opacity-90 text-indigo-100 mb-auto bg-opacity-80 p-10 rounded-3xl shadow-xl '>
          <h3 className='text-xl sm:text-3xl'>ReactJS Antalya</h3>
          <h3 className='sm:text-xl text-md mt-5'>24 March 2021</h3>
          <p className='text-sm sm:text-lg mt-10 '>
        ...
        <a
          href='/'
          className='mx-auto mt-10 p-2 bg-white bg-opacity-80 rounded-lg text-md sm:text-2xl text-indigo-900 hover:text-indigo-500'
        >
          Buy a ticket!
        </a>
      </div>
